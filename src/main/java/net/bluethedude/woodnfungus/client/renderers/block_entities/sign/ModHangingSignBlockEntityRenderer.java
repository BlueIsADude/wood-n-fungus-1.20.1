...
public class ModHangingSignBlockEntityRenderer extends ModSignBlockEntityRenderer<ModHangingSignBlockEntity> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(new Identifier(WoodNFungus.MOD_ID, "hanging_sign/azalea"), "main");
    ...
    public ModHangingSignBlockEntityRenderer(BlockEntityRendererFactory.Context context) {
        super(context);
        MODELS = ImmutableMap.of(ModWoodTypes.PALM, new HangingSignModel(context.getLayerModelPart(LAYER_LOCATION)));
    }
    ...
    public void render(ModHangingSignBlockEntity signBlockEntity, float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, int j) {
        ...
        HangingSignModel hangingSignModel = this.MODELS.get(ModWoodTypes.PALM);
        hangingSignModel.updateVisibleParts(blockState);
        this.render(signBlockEntity, matrixStack, vertexConsumerProvider, i, j, blockState, abstractSignBlock, ModWoodTypes.PALM, hangingSignModel);
    }
    ...
    SpriteIdentifier getTextureId(WoodType signType) {
        return new SpriteIdentifier(TexturedRenderLayers.SIGNS_ATLAS_TEXTURE, new Identifier(WoodNFungus.MOD_ID,"entity/signs/hanging/palm"));
    }
