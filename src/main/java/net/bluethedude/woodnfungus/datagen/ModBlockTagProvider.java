...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(BlockTags.PLANKS)
                ...
                .add(ModBlocks.LIGNUM_VITAE_PLANKS)
                .add(ModBlocks.BOULDERBARK_PLANKS)
                .add(ModBlocks.SPLITPINE_PLANKS)
                .add(ModBlocks.BLUE_MEANIE_PLANKS)
                .add(ModBlocks.DEVILS_TOOTH_PLANKS)
                .add(ModBlocks.STAINED_DEVILS_TOOTH_PLANKS)
                .add(ModBlocks.SAVORSHROOM_PLANKS)
                .add(ModBlocks.WITCHSTOOL_PLANKS);

        getOrCreateTagBuilder(BlockTags.FENCES)
                .add(ModBlocks.PALM_FENCE)
                .add(ModBlocks.LIGNUM_VITAE_FENCE)
                .add(ModBlocks.BOULDERBARK_FENCE)
                .add(ModBlocks.SPLITPINE_FENCE)
                .add(ModBlocks.BLUE_MEANIE_FENCE)
                .add(ModBlocks.DEVILS_TOOTH_FENCE)
                .add(ModBlocks.STAINED_DEVILS_TOOTH_FENCE)
                .add(ModBlocks.SAVORSHROOM_FENCE)
                .add(ModBlocks.WITCHSTOOL_FENCE);

        getOrCreateTagBuilder(BlockTags.FENCE_GATES)
                .add(ModBlocks.PALM_FENCE_GATE)
                .add(ModBlocks.LIGNUM_VITAE_FENCE_GATE)
                .add(ModBlocks.BOULDERBARK_FENCE_GATE)
                .add(ModBlocks.SPLITPINE_FENCE_GATE)
                .add(ModBlocks.BLUE_MEANIE_FENCE_GATE)
                .add(ModBlocks.DEVILS_TOOTH_FENCE_GATE)
                .add(ModBlocks.STAINED_DEVILS_TOOTH_FENCE_GATE)
                .add(ModBlocks.SAVORSHROOM_FENCE_GATE)
                .add(ModBlocks.WITCHSTOOL_FENCE_GATE);
        ...
        getOrCreateTagBuilder(BlockTags.BUTTONS)
                ...
                .add(ModBlocks.LIGNUM_VITAE_BUTTON)
                .add(ModBlocks.BOULDERBARK_BUTTON)
                .add(ModBlocks.SPLITPINE_BUTTON)
                .add(ModBlocks.BLUE_MEANIE_BUTTON)
                .add(ModBlocks.DEVILS_TOOTH_BUTTON)
                .add(ModBlocks.STAINED_DEVILS_TOOTH_BUTTON)
                .add(ModBlocks.SAVORSHROOM_BUTTON)
                .add(ModBlocks.WITCHSTOOL_BUTTON);
        ...
        getOrCreateTagBuilder(BlockTags.PRESSURE_PLATES)
                ...
                .add(ModBlocks.LIGNUM_VITAE_PRESSURE_PLATE)
                .add(ModBlocks.BOULDERBARK_PRESSURE_PLATE)
                .add(ModBlocks.SPLITPINE_PRESSURE_PLATE)
                .add(ModBlocks.BLUE_MEANIE_PRESSURE_PLATE)
                .add(ModBlocks.DEVILS_TOOTH_PRESSURE_PLATE)
                .add(ModBlocks.STAINED_DEVILS_TOOTH_PRESSURE_PLATE)
                .add(ModBlocks.SAVORSHROOM_PRESSURE_PLATE)
                .add(ModBlocks.WITCHSTOOL_PRESSURE_PLATE);
        ...
        getOrCreateTagBuilder(BlockTags.SLABS)
                ...
                .add(ModBlocks.LIGNUM_VITAE_SLAB)
                .add(ModBlocks.BOULDERBARK_SLAB)
                .add(ModBlocks.SPLITPINE_SLAB)
                .add(ModBlocks.BLUE_MEANIE_SLAB)
                .add(ModBlocks.DEVILS_TOOTH_SLAB)
                .add(ModBlocks.STAINED_DEVILS_TOOTH_SLAB)
                .add(ModBlocks.SAVORSHROOM_SLAB)
                .add(ModBlocks.WITCHSTOOL_SLAB);
        ...
        getOrCreateTagBuilder(BlockTags.STAIRS)
                ...
                .add(ModBlocks.LIGNUM_VITAE_STAIRS)
                .add(ModBlocks.BOULDERBARK_STAIRS)
                .add(ModBlocks.SPLITPINE_STAIRS)
                .add(ModBlocks.BLUE_MEANIE_STAIRS)
                .add(ModBlocks.DEVILS_TOOTH_STAIRS)
                .add(ModBlocks.STAINED_DEVILS_TOOTH_STAIRS)
                .add(ModBlocks.SAVORSHROOM_STAIRS)
                .add(ModBlocks.WITCHSTOOL_STAIRS);
